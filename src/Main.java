...
public class Main {
    ...
    //შექმენი აბსტრაკტული კლასი მანქანა, რომელსაც ექნება 2 აბსრატქული მეთოდი: სიჩქარე და გერი, და 1 არა აბსტრაქტული კლასი რომელიც ამ აბსრაქულ სლასს დაექსტენდებს, გადატვირთე
